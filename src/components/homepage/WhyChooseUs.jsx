        ...
        <div className="col-span-6">
          ...
          <div className="flex justify-center">
            <Image
              ...
              height={1000}
              width={1000}
              className="h-[290px] w-[300px] mt-2"
              alt="choose"
            />
          </div>
        </div>
        <div className="col-span-3 mr-5">
          <div className="border-2 border-gray-300 bg-primary text-white hover:bg-white hover:text-black p-3 rounded-lg mb-3">
            ...
            <p className="text-center mt-2">
              ...
              strategies to dedicated client support, we go above and beyond to
          ...
          <div className="border-2 border-gray-300 hover:bg-primary hover:text-white p-3 rounded-lg">
            ...
            <p className="text-center mt-2">
              We understand that each client has unique financial objectives and
              risk tolerances. That&apos;s why our team of experienced advisors
              crafts customized investment strategies that align with your
              goals, whether it&apos;s wealth preservation, growth, or
              philanthropic endeavors.
            </p>
          </div>
        </div>
        <div className="mt-10 col-span-3 mr-3">
          ...
          <div className="border-2 border-gray-300 p-3 rounded-lg bg-primary text-white hover:bg-white hover:text-black">
            ...
            <p className="text-center mt-2">
              ...
              partnership. We are committed to building long-term relationships
